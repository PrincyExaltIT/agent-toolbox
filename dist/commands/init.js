...
import { PROJECT_CONFIG_FILE, projectConfigExists, readProjectConfig, writeProjectConfig, } from '../project.js';
export async function init(opts) {
    ...
    if (!profileName) {
        ...
        if (profiles.length === 0) {
            throw new Error('No profiles found in your content root.\n→ Create one with `atb new profile <name>` first.');
        }
